...
mysql_select_db($db);
$ssqlo="select * from subcatalogos where idcat='".$_POST['categoria']."'";
        ...
        <td height="378" valign="top"><table width="696" height="136" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#0369A7">
          ...
          <tr>
            <td valign="top"><table width="513" height="595" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="513" height="595" valign="top"><table width="266" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="235"><strong><font size="2" face="Arial, Helvetica, sans-serif">Listar Productos de un Catalogo</font></strong></td>
                  </tr>
                </table>
                          <p><font size="2" face="Arial, Helvetica, sans-serif">Por favor selecciona el 
                            catalogo de productos que deseas listar...</font></p>
                          <form name="form1" method="post" action="listalos_productos3.php">
