...
mysql_select_db($db);
$ssqlo="delete from subcatalogos where idsubcat='$cualborra'";
mysql_query($ssqlo);
$ssqlo2="delete from productos where idsubcat='$cualborra'";
mysql_query($ssqlo2);
              ...
              <tr>
                <td width="513" height="595" valign="top"><table width="184" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="153"><strong><font size="2" face="Arial, Helvetica, sans-serif">Borrando Subcategoria </font></strong></td>
                  </tr>
                </table>
                          <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><br></font>
                            <p align="center"><font size="2" face="Arial, Helvetica, sans-serif">Borrado Subcategoria...</font></p>
                          </div>
