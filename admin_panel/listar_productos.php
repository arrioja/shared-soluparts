...
<html>
<head>
<title>Modificar un productos...</title>
...
<table width="735" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
              ...
              <tr>
                <td width="513" height="595" valign="top"><table width="314" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="283"><strong><font size="2" face="Arial, Helvetica, sans-serif">Modificar un producto</font></strong></td>
                  </tr>
                </table>
                        <form name="form1" method="get" action="listalos_productos.php">
                            <p align="left" class="style1">-Por favor seleccione la categoria: </p>
	...
	?>
                              ...
                              <input name="categoria" type="hidden" id="categoria" value="<? echo $_POST['categoria']?>">
                            </font></p>
                          <p> <font size="2" face="Arial, Helvetica, sans-serif">
