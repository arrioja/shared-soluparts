...
<html>
<head>
<title>Agregar un Nuevo Catalogo</title>
    ...
    <td><table width="713" height="428" border="0" cellpadding="00" cellspacing="0">
      <tr>
        <td height="378" valign="top"><table width="696" height="136" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#0369A7">
          ...
          <tr>
            <td valign="top"><table width="513" height="101" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="513" valign="top"><table width="237" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="206"><font size="2" face="Arial, Helvetica, sans-serif"><strong><font size="2" face="Arial, Helvetica, sans-serif">Nueva Subcategoria </font></strong></font></td>
                    </tr>
                  </table>
                  <p align="center"><font size="2" face="Arial, Helvetica, sans-serif">Indique el nombre de la subcategoria 
                    a agregar y luego pulse el boton continuar:</font></p>
                  <form name="form1" method="post" action="added_subcat.php">
                    <p><font size="2" face="Arial, Helvetica, sans-serif">Indique el catalogo:</font> </p>
                    <p>
                      <input name="categoria" type="hidden" id="categoria" value="1">
                      <font size="2" face="Arial, Helvetica, sans-serif">Sub-Categoria:</font></p>
                  ...
                  <p>&nbsp;</p>
                          <p align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="index.php"><img src="regresar.gif" width="117" height="34" border="0"></a><a href="erase_cat.php"><br>
