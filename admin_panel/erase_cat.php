...
<table width="735" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
              ...
              <tr>
                <td width="513" height="595" valign="top"><table width="314" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="283"><strong><font size="2" face="Arial, Helvetica, sans-serif">Borrar Catalogo </font></strong></td>
                  </tr>
                </table>
                          <form name="form1" method="post" action="erased_cat.php">
                            <p align="center">&nbsp;</p>
	...
	?>
                            ...
                            <p> <font size="2" face="Arial, Helvetica, sans-serif">
                              <input type="submit" name="Submit" value="Borrar Catalogo">
                            </font></p>
                            <p><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><strong>-Nota:</strong></font><font size="2" face="Arial, Helvetica, sans-serif"> Al borrar el Catalogo los productos que este contenia seran borrados, por 
                              lo tanto<br>
                            debe tener en cuenta esto cuando vaya a borrar alguno de los catalogos.</font></p>
                        </form>
                          <p>&nbsp;</p>
