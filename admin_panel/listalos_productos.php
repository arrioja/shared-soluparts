...
mysql_select_db($db);
$ssqlo="select * from productos where idcat=1 and idsubcat='".$subcatalogo."'";
  ...
  <tr>
        ...
        <td height="378" valign="top"><table width="696" height="136" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#0369A7">
          ...
          <tr>
            <td valign="top"><table width="513" height="595" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="513" height="595" valign="top"><table width="249" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="218"><strong><font size="2" face="Arial, Helvetica, sans-serif">Modificar Producto</font></strong></td>
                  </tr>
                </table>
                          <p><font size="2" face="Arial, Helvetica, sans-serif">Los productos para la categoria 
                          seleccionada son:</font></p>
                          <form action="modifica_pro.php" method="post" name="formo">
	...
	?>
                            ...
                            <p> <font size="2" face="Arial, Helvetica, sans-serif">
                              <input type="submit" name="Submit" value="Modificar Producto...">
                            </font></p>
                        </form>
                          <br>
<p>&nbsp;</p>
