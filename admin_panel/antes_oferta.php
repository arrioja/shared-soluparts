              ...
              <tr>
                <td width="513" height="595" valign="top"><table width="314" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="283"><strong><font size="2" face="Arial, Helvetica, sans-serif">Agregando Oferta</font></strong></td>
                  </tr>
                </table>
                          <form name="form1" method="post" action="listar_productos3.php">
                            <p align="center">&nbsp;</p>
