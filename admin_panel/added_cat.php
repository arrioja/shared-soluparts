<?
include("../config.php");
$name=str_replace("\'","",$_POST['nombre']);//recibe el nombre del catalogo a agregar
$num=rand(1,100000);
$nam=str_replace(" ","",$name);

//para asignarle un id al catalogo
$ido=fopen("../cuenta_cat.txt","r+");
...
$tabla="<a class=\'categoria\' title=\'".$name."\' href=\'verproducto.php?idcat=".$recibo."&txt_criterio=&pagina=1&criterio=\' id=\"".$nam."\" onMouseOver=\"startanimation(\'".$nam."\')\" onMouseOut=\"stopanimation()\">".$name."</a><br>";
...
mysql_select_db($db);
$ssqlo="INSERT INTO `catalogos` VALUES ('$recibo', '$name', '$tabla', '$select')";
mysql_query($ssqlo);
mysql_close($linko);

//para aumentar el contador de los catalogos
$ido2=fopen("../cuenta_cat.txt","w+");
              ...
              <tr>
                <td width="513" height="595" valign="top"><table width="159" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="128"><strong><font size="2" face="Arial, Helvetica, sans-serif">Agregar Catalogo </font></strong></td>
                  </tr>
                </table>
                          <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><br>
                          Se agrego correctamente 
                          el catalogo: <i><? echo $name?></i> </font>                          </div>
                          <p>&nbsp;</p>
                  <p>&nbsp; </p>
