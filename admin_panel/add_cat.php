        ...
        <td height="378" valign="top"><table width="696" height="136" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#0369A7">
          ...
          <tr>
            <td valign="top"><table width="513" height="101" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="513" valign="top"><table width="159" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="128"><font size="2" face="Arial, Helvetica, sans-serif"><strong><font size="2" face="Arial, Helvetica, sans-serif">Nuevo Catalogo</font></strong></font></td>
                    </tr>
                  </table>
                  <p align="center"><font size="2" face="Arial, Helvetica, sans-serif">Indique el nombre del catalogo 
                    a agregar y luego pulse el boton continuar:</font></p>
                  <form name="form1" method="post" action="added_cat.php">
                    ...
                    <p align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="index.php"><br>
                          <img src="regresar.gif" width="117" height="34" border="0"><br>
                          </a></font></p>
                  </form>
                  <p>&nbsp;</p>
