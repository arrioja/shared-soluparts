            ...
            <td valign="top"><table width="513" height="595" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="513" height="595" valign="top"><table width="314" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="31"><div align="right"><font size="2" face="Arial, Helvetica, sans-serif"><a href="erase_cat.php"></a></font><strong><font size="2" face="Arial, Helvetica, sans-serif"><a href="antes_listar_productos.php"><img src="modificar.gif" width="27" height="27" border="0" align="left"></a><a href="add_cat.php"></a></font></strong></div></td>
                    <td width="283"><strong><font size="2" face="Arial, Helvetica, sans-serif">Seleccione la noticia a editar </font></strong></td>
                  </tr>
                </table>
                          <form name="form1" method="post" action="update_noticia.php">
                            <p align="center">&nbsp;</p>
                            <p align="center"><font size="2" face="Arial, Helvetica, sans-serif">-Seleccione la noticia que desea Editar:</font></p>
                            <table border="1" width="500" align="center" cellspacing="0" bordercolor="#B2CCE5">
                              <tr bordercolor="#000000">
                                <td width="40%" bgcolor="#000066"><span class="style1"><font size="2" face="Arial, Helvetica, sans-serif">Seleccione</font></span></td>
                                <td width="60%" bgcolor="#000066"><div align="left" class="style1"><font size="2" face="Arial, Helvetica, sans-serif">Titular</font></div></td>
                              </tr>
                              <?
					  $ssq="select * from noticias";
					  $res=mysql_query($ssq);
