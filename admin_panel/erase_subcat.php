...
<table width="735" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
              ...
              <tr>
                <td width="513" height="595" valign="top"><table width="314" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="283"><strong><font size="2" face="Arial, Helvetica, sans-serif">Borrar Sub-categoria</font></strong></td>
                  </tr>
                </table>
                          <form name="form1" method="post" action="erased_subcat.php">
                            <p> <font size="2" face="Arial, Helvetica, sans-serif">
                              <select name="cualborra">
                                <?
	 for ($io=0;$io<$nums;$io++)
	  {
	...
	?>
                            ...
                            <p> <font size="2" face="Arial, Helvetica, sans-serif">
                              <input type="submit" name="Submit" value="Borrar Sub-categoria">
                            </font></p>
                            <p><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><strong>Nota:</strong></font><font size="2" face="Arial, Helvetica, sans-serif"> Al borrar la subcategoria los productos que este contenia seran borrados, por 
                              lo tanto debe tener en cuenta esto cuando vaya a borrar alguno de las Subcategorias.</font></p>
                        </form>
                          <p>&nbsp;</p>
